...
copy /Y "%~dp0..\SqlServer\appsettings.Production.json" "%WORKING_DIR_WIN%\api-dotnet-mssql\appsettings.Production.json" >nul
copy /Y "%~dp0..\PostgreSQL\appsettings.Production.json" "%WORKING_DIR_WIN%\api-dotnet-postgres\appsettings.Production.json" >nul
