...
docker run --name local_postgres -p 5432:5432 --network pilot-net -m 512m -e POSTGRES_USER=DevUser -e POSTGRES_PASSWORD=Pwo_698UVtra -e POSTGRES_DB=devDb -v "postgres_data:/var/lib/postgresql" -v ".:/local_working" -d postgres
